...
var projectPersonalBlog = document.querySelector('#personal-blog')
// console.log(projectPersonalBlog)
projectPersonalBlog.addEventListener('click', function () {
    location.href = "detailPersonalBlog.html"
})